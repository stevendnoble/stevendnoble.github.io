---
layout: recipe
title: Baked Feta & Tomato Pasta with Chicken & Broccoli
description: >
...
tags: ["Comfort Food", "Quick and Easy"]
...
intro: >
  This Baked Feta & Tomato Pasta with Chicken & Broccoli turns cherry tomatoes,
  feta, olive oil, and pan juices into a creamy sauce right in the baking dish.
  The chicken and broccoli bake alongside the tomatoes, then everything gets
  tossed with pasta, garlic, and fresh basil for a simple dinner that feels much
  richer than the effort involved.
ingredients:
...
instructions:
  ...
  - step:
    ...
    description: Rinse the cherry tomatoes and place them in a 9x13-inch baking dish. Cut the broccoli into bite-sized florets, discarding the tough stems, and add it to the dish.
  - step:
    title: Add the Chicken and Feta
    description: Cut the chicken into 1-inch to 1½-inch cubes. Add the chicken to the baking dish and mix it with the tomatoes and broccoli. Place the block of feta in the center.
  - step:
    title: Season and Bake
    description: Drizzle everything with the olive oil and sprinkle with salt and black pepper. Bake for 35 minutes, or until the chicken is cooked through and the tomatoes have softened and released their juices.
  - step:
    title: Cook the Pasta
    description: While the feta mixture bakes, prepare the pasta according to the package instructions. Reserve a little pasta water before draining in case the sauce needs loosening.
  - step:
    title: Finish the Sauce
    description: When the baking dish comes out of the oven, sprinkle the minced garlic and chopped basil over the hot feta mixture. Stir well, using the liquid in the dish and the softened feta to create a creamy sauce.
  - step:
    title: Toss and Serve
    description: Add the drained pasta to the baking dish and toss until everything is coated. If the sauce feels too thick, add a splash of reserved pasta water. Serve warm.
prep_time: PT15M
cook_time: PT35M
total_time: PT50M
nutrition:
...
the olive oil helps bring everything together once the dish is stirred. Adding
chicken and broccoli turns the viral-style pasta into a full dinner without
needing a separate protein or vegetable.

The garlic and basil go in after baking so they stay bright. The heat from the
