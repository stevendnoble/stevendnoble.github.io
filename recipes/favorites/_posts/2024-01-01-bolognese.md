...
intro: >
  Bolognese is a slow, savory meat sauce rather than a quick tomato sauce with meat in it. The sauce gets its
  depth from a patient soffritto, browned meat, a modest amount of tomato, wine, milk, and enough simmering time
  for everything to settle into something rich and comforting.
ingredients:
  - 2 tbsp olive oil
  - 2 tbsp butter
...
instructions:
  - step:
    title: Cook the soffritto
    description: Heat olive oil and butter in a Dutch oven over medium heat. Add onion, carrot, and celery, then cook for 8-10 minutes until softened. Stir in garlic for 1 minute.
  - step:
    title: Brown the meat
    description: Add beef, pork, salt, and pepper. Cook until the meat loses its raw color and begins to brown, breaking it up as it cooks.
  - step:
    title: Add tomato paste and wine
    description: Stir in tomato paste and cook for 2 minutes. Add wine and simmer until mostly reduced, scraping up any browned bits.
  - step:
    title: Simmer slowly
    description: Add milk, crushed tomatoes, bay leaf, and nutmeg if using. Bring to a low simmer and cook uncovered for 2-3 hours, stirring occasionally and adding a splash of water if it gets too thick.
  - step:
    title: Toss with pasta
    description: Cook pasta in salted water until al dente. Toss with the sauce and a splash of pasta water until glossy. Serve with parmesan.
prep_time: PT20M
cook_time: PT3H
total_time: PT3H20M
nutrition:
