...
intro: >
  Vietnamese Shaking Beef, or Bò Lúc Lắc, is a fast, high-heat stir-fry built
  around tender cubes of beef, a savory fish sauce-soy-oyster sauce marinade, and
  a bright lime-pepper dipping sauce. Using filet mignon makes this version extra
  tender, so the key is a quick sear and a light touch.
ingredients:
...
divided_ingredients:
  - division:
    title: For the Beef and Marinade
    ingredients:
      - 1 pound filet mignon, cut into 1-inch cubes
      - 2 cloves garlic, minced
      - 1 tablespoon fish sauce
  ...
  - division:
    ...
    ingredients:
      ...
      - 1 bell pepper, chopped, optional
  - division:
    title: For the Salad Base
    ingredients:
      - Lettuce, such as butter lettuce or romaine
      - Tomato wedges
      - Cucumber slices
  - division:
    title: For the Lime Pepper Dipping Sauce
    ingredients:
      - ½ teaspoon salt
      - ½ teaspoon black pepper
      - Juice of ½ lime
instructions:
  - step:
    ...
    description: Combine the garlic, fish sauce, soy sauce, oyster sauce, sugar, black pepper, and oil. Toss the filet mignon cubes in the marinade and let them marinate for 30 minutes, tossing once halfway through.
  - step:
    title: Prep the Vegetables and Sauce
    description: Prepare the red onion, bell pepper if using, lettuce, tomatoes, and cucumber. Stir together the salt, black pepper, and lime juice for the dipping sauce.
  - step:
    title: Sear the Beef
    description: Heat a wok or skillet over high heat until very hot, then add the neutral oil. Add the beef in a single layer, taking care not to overcrowd the pan. Let sear without moving for about 1 minute, then shake or flip the pan. Cook another 1-2 minutes, until browned but still medium-rare inside. Remove the beef and set aside.
  - step:
    title: Finish the Stir-Fry
    description: In the same pan, add the butter, red onion, and bell pepper if using. Stir-fry quickly for 1-2 minutes. Return the beef to the pan and toss everything together for about 30 seconds.
  - step:
    title: Serve
