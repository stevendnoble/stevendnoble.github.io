...
intro: >
  Beef Massaman Curry is a slow, coconut-rich curry with tender beef, potatoes,
  onion, peanuts, and warm spices. It is mellow, savory, lightly sweet, and ideal
  for a low simmer or slow cooker-style dinner.
ingredients:
...
instructions:
  - step:
    ...
    description: Heat the oil in a Dutch oven over medium-high heat. Brown the beef in batches, then transfer to a plate.
  - step:
    title: Fry the Curry Paste
    description: Add the onion to the pot and cook for 2-3 minutes. Stir in the curry paste and cook for 1-2 minutes, until fragrant.
  - step:
    title: Simmer the Curry
    description: Add the coconut milk, beef stock, cinnamon, star anise, cardamom if using, and browned beef. Bring to a simmer, cover, and cook gently for 1½ hours.
  - step:
    title: Add Potatoes and Peanuts
