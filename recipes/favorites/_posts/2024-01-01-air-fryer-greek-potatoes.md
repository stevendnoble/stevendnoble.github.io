---
layout: recipe
title: Air Fryer Greek Potatoes
description: >
...
intro: >
  These Greek potatoes keep the lemon, garlic, oregano, and olive oil flavor of the classic version, but use
  the air fryer for crisp edges and a faster cook time. They are especially good with gyros, grilled meats,
  Greek salad, or anything that wants a bright, salty side.
ingredients:
...
instructions:
  - step:
    title: Soak and dry
    description: Soak potato wedges in cold water for 20 minutes if you have time. Drain and dry very well with a towel.
  - step:
    title: Season
    description: Toss potatoes with olive oil, lemon juice, garlic, oregano, salt, pepper, and paprika.
  - step:
    title: Air fry
    description: Preheat the air fryer to 400°F. Arrange potatoes in a single layer and cook for 18-24 minutes, shaking or turning halfway, until golden and crisp at the edges.
  - step:
    title: Finish
    description: Transfer to a platter and top with feta if using, parsley, and a squeeze of lemon. Serve with tzatziki or Greek yogurt sauce.
prep_time: PT15M
cook_time: PT24M
total_time: PT39M
nutrition:
