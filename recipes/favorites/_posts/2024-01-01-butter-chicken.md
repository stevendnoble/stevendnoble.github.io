...
tags: ['Favorites', 'Butter Chicken', 'Indian Cuisine', 'Chicken', 'Dinner']
...
intro: >
  Butter Chicken is a cozy, creamy curry built around tender chicken in a gently
  spiced tomato sauce. Yogurt tenderizes the chicken, while butter, cream, and
  fenugreek give the sauce its rounded restaurant-style flavor.
ingredients:
...
instructions:
  - step:
    ...
    description: In a bowl, combine the chicken, yogurt, lemon juice, ginger, garlic, garam masala, cumin, coriander, paprika, turmeric, cayenne if using, and 1 teaspoon salt. Cover and refrigerate for at least 30 minutes, or up to overnight.
  - step:
    title: Brown the Chicken
    description: Heat 1 tablespoon butter and the oil in a large skillet over medium-high heat. Add the chicken in batches and brown on the outside; it does not need to be fully cooked yet. Transfer to a plate.
  - step:
    title: Cook the Onion
    description: Reduce the heat to medium. Add 1 tablespoon butter and the onion to the skillet. Cook until softened, about 5 minutes, scraping up any browned bits.
  - step:
    title: Build the Sauce
    description: Stir in the crushed tomatoes, tomato paste, sugar, and remaining ½ teaspoon salt. Simmer for 8-10 minutes, until slightly thickened.
  - step:
    title: Simmer the Chicken
    description: Return the chicken and any juices to the pan. Simmer gently for 10-12 minutes, until the chicken is cooked through and tender.
  - step:
    title: Finish with Cream
    description: Stir in the heavy cream, remaining 1 tablespoon butter, and crushed fenugreek leaves if using. Simmer for 2-3 minutes, then taste and adjust seasoning.
  - step:
    title: Serve
    description: Garnish with cilantro and serve with basmati rice or naan.
prep_time: PT20M
cook_time: PT35M
total_time: PT1H25M
nutrition:
